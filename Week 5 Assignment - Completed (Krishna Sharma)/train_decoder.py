...
from modules.semids import batch_to, next_batch, SemanticIdTokenizer
...
def train(iterations=500000,
    ...
    code_to_item = {}
    for item_id, sem_code in enumerate(tokenizer.cached_ids):
        # remove dedup column
        code = tuple(sem_code[:-1].tolist())
...
if __name__ == "__main__":
    ...
    train(args.iterations, args.batch_size, args.learning_rate, args.weight_decay, args.dataset_folder,
          ...
          args.vae_input_dim, args.vae_emb_dim, args.vae_hidden_dims, args.vae_codebook_size,
